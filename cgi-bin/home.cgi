...
<td valign="center" align="center" width="5%"><a href="http://www.ird.fr" target="_blank"><img alt="IRD logo" src="$Configuration::HTML_URL/logos/logo_ird.png" width="35%"/></a></td>
<td valign="center" align="center" width="5%"><a href="http://www.umr-rpb.fr" target="_blank"><img alt="IPME logo" src="$Configuration::HTML_URL/logos/IPME_logo.png"width="35%"/></a></td>
<td valign="center" align="center" width="5%"><a href="http://africarice.org/" target="_blank"><img alt="AfricaRice logo" src="$Configuration::HTML_URL/logos/AfricaRice_logo.jpg" width="35%"/></a></td>
<td valign="center" align="center" width="5%"><a href="http://www.grisp.net/main/summary" target="_blank"><img alt="GRiSP logo" src="$Configuration::HTML_URL/logos/GRiSP_logo.jpg" width="35%"/></a></td>
<td valign="center" align="center" width="5%"><a href="http://www.diade-research.fr/" target="_blank"><img alt="DIADE logo" src="$Configuration::HTML_URL/logos/DIADE_logo.png" width="35%"/></a></td>
<td valign="center" align="center" width="5%"><a href="http://www.cirad.fr/" target="_blank"><img alt="CIRAD logo" src="$Configuration::HTML_URL/logos/CIAT-Logo-p.jpg" width="35%"/></a></td>
<td valign="center" align="center" width="5%"><a href="http://www.cirad.fr/" target="_blank"><img alt="CIRAD logo" src="$Configuration::HTML_URL/logos/CIRAD_logo.gif" width="35%"/></a></td>
</td>
</tr>
</table>
</div>
...
sub Display_InputForm()
{
	...
	print $cgi->start_html(
		...
		-script => [
					...
					{'language'=>'javascript', 'src'=>"$Configuration::HTML_URL/carrousel/js/jquery.jDiaporama.js"},
					{'language'=>'javascript', 'src'=>"$Configuration::HTML_URL/carrousel/js/script.js"},],
	...
	#result table
	print "<br/><br/>";
	print "<input type='button' class='submit' value='Search' onclick='getBasic2(\"$Configuration::CGI_URL/display_ajax.cgi\", $session);'/>";
	print "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";
	...
	print "<input type='button' class='submit' value='Search' style='left:70%; position:absolute;' onclick='getAdvanced(counter,\"$Configuration::CGI_URL/display_ajax.cgi\", $session);'/>";
...
SEARCH
	...
	#informations that the user isn't connected
	my $LOG = "$Configuration::TMP_DIR/log.info.$session";	
    open (F , ">", $LOG) or die ("erreur: \n $!\n");
	print F "no \n";
	close(F);
	
    print "<form type='form_Login' method ='post' action ='login.cgi'> ";
	print "<input type='hidden' name='test_session' value='$session'>";
	print "<center>";
